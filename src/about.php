...
<div class="mainSection">
    ...
    <div class="mainTitles">
        ...
        <div class="titles">
            <h1>Um rannsóknina</h1>
        </div>


        <a href="#" class="toggler"><h3>Rannsóknin</h3></a>
        <div>
        ...
        <a href="#" class="toggler"><h3>Framkvæmd rannsóknar</h3></a>
        <div>
        ...
        <a href="#" class="toggler"><h3>Gagnasöfnun</h3></a>
        <div>
        ...
        <a href="#" class="toggler"><h3>Rannsóknaraðilar</h3></a>
        <div>
        ...
        <a href="#" class="toggler"><h3>Samstarfsaðilar</h3></a>
        <div>
